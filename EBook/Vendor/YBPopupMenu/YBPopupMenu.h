...
/**
 设置字体种类，自定义cell时忽略，Defalut is system,
 */
...
/**
 设置选中字体颜色 自定义cell时忽略, Default is nil
 */

@property (nonatomic, strong) UIColor *selectedTitleColor;

/**
 设置选中背景颜色 自定义cell时忽略, Default is nil
*/
@property (nonatomic, strong) UIColor *selectedBackgroundColor;

/**
 设置选中的下标，必须配合selectedTitleColor使用
 */
...
/**
 popupMenu的Separator颜色，Default is lightGray;
 */
@property (nonatomic, strong) UIColor *separatorColor;

/**
 popupMenu的Separator距离左边的距离，Default is 0;
 */
@property (nonatomic, assign) CGFloat lineLeftMargin;

/**
 popupMenu的Separator距离右边的距离，Default is 0;
 */
