...
- (void)drawRect:(CGRect)rect
{
    ...
    UIBezierPath *bezierPath = [UIBezierPath bezierPathWithRect:CGRectMake(_lineLeftMargin, rect.size.height - 0.5, rect.size.width - _lineLeftMargin - _lineRightMargin, 0.5)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.lineLeftMargin = _lineLeftMargin;
    cell.lineRightMargin = _lineRightMargin;
    if (indexPath.row == self.selectedIndex && _selectedTitleColor) {
        cell.textLabel.textColor = _selectedTitleColor;
    } else {
        cell.textLabel.textColor = _textColor;
    }
    
    if (indexPath.row == self.selectedIndex && _selectedBackgroundColor) {
...
- (void)setIsShowShadow:(BOOL)isShowShadow
{
    ...
    self.layer.shadowOpacity = isShowShadow ? 0.08 : 0;
    self.layer.shadowOffset = CGSizeMake(1.5, 3.5);
    self.layer.shadowRadius = isShowShadow ? 10.0 : 0;
}
